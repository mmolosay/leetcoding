...
fun e70_climbStairs(n: Int): Int {
     ...
     * distinct ways to climb to the previous two steps, because we can either take one step from the i-1th step
     * or two steps from the i-2th step. This recurrence relation is similar to the Fibonacci sequence.
     */
    for (i in 1 until n) {
